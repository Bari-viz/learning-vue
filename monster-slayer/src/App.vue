  ...
  <main>
    ...
    <div id="game">
      ...
      <section class="container" v-if="winner">
        ...
        <button @click="startGame">Start Name Game</button>
...
watch: {
  ...
  monsterHealth(value) {
    ...
    methods: {
      ...
      attackPlayer() {
        const attackValue = this.getRandomValue(13,8 ) ;
      ...
      addLogMessage(who, what, value) {
        ...
        // unshift add something at the begining of the array while push add something at the ennd of th array
      }
    },
  }
</script>
